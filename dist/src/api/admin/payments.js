...
class AdminPaymentsHandler extends request_handler_1.default {
    async list(req, res) {
        return this.splitInstance(async function () {
            ...
            const result = payments.map((p) => ({
                ...
                user: p.user ? {
                    ...p.user,
                    phone: p.user.phone?.() ?? p.user.phone,
                } : null,
            }));
...
exports.default = AdminPaymentsHandler;
__decorate([
    (0, common_1.All)(),
...
], AdminPaymentsHandler.prototype, "list", null);
